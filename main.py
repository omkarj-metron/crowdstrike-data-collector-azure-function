#!/usr/bin/env python3
"""
Standalone script for CrowdStrike RTR data collection.
This script can be run directly without Azure Functions.
"""
import os
import sys
import logging
...
def main():
    ...
    try:
        # Setup required directories (creates logs/ and rtr-result/ in current directory)
        logs_dir, rtr_result_dir = ensure_directories()
        print(f"Logs directory: {logs_dir}")
        print(f"RTR results directory: {rtr_result_dir}")
